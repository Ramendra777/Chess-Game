...
// connecting to server in client side 
// we use socket.on here as we do emit these classes in app.js(server side).
// every each on we use renderboard.
...
// below step for erroe showing in console if wrong move is gona happened.
// socket.on("invalidMove", function() {
//     throw console.error("Invalid Move");
//     renderBoard();
// });
